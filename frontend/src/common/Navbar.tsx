...
export default function Navbar() {
    ...
    return <>
        ...
        <div className="fixed top-0 left-0 h-full w-[400px] max-w-[60vw] bg-gray-700 shadow-lg transition-transform duration-300">
            <div className="flex flex-col items-center box-content rounded-lg px-2 hover:cursor-pointer transition-all duration-200 mt-8"
            ...
            <div className="flex w-full flex-col items-center gap-4 mt-5">
                ...
                rounded-lg px-2 w-[24vw] max-w-[180px] hover:cursor-pointer hover:shadow-lg transition-all duration-200" onClick={() => modeChange('speak')}
                >
